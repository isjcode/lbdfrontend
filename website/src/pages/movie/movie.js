      ...
      <>
        {currentItems &&
          currentItems.map((item) =>
            item.Body ? (
              <div data-id={item.Id} key={nanoid()} className="review">
                <div
                ...
                >
                  ...
                  <span className="comments">
                    <i onClick={handleCommentClick} data-id={item.Id} className="fa-solid fa-comment"></i>
                    {item.CommentCount}
                  </span>
                  <ul className="rating-score" data-rating={`${item.Rating / 2}`}>
        ...
        <div className="inner-page-wrapper">
          <div className="descriptionandbox">
            <div className="description">
              <h3>
                {" "}
                {movie && movie.Name} ({movie && movie.YearNumber})
              </h3>
          ...
          <div className="container">
            ...
            <div className="content-container">
              ...
              <div className={`content ${getActiveClass(2, "active-content")}`}>
                {genres.map((p) => (
                  <a key={nanoid()} onClick={handlePersonClick}>
                    {" "}
                    {p.Name}{" "}
                  </a>
                ))}
